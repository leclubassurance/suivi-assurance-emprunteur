...
assert.equal(
  dossierHasAdeAssistBypass({
    adeStudyAssist: {
      ...
      kereisPatches: {},
      threads: { kereis: { messages: [], status: "idle" }, study: { messages: [], status: "ready" } },
      messages: [],
    },
  }),
  true,
...
assert.equal(
  dossierHasAdeAssistBypass({
    adeStudyAssist: {
      ...
      overrides: { currentTotalEur: 1, proposedTotalEur: 1, remainingMonths: 12 },
      kereisPatches: {},
      threads: { kereis: { messages: [], status: "idle" }, study: { messages: [], status: "needs_input" } },
      messages: [],
    },
  }),
  true,
...
assert.equal(
  dossierHasAdeAssistBypass({
    adeStudyAssist: {
      ...
      overrides: {},
      kereisPatches: {},
      threads: { kereis: { messages: [], status: "ready" }, study: { messages: [], status: "idle" } },
      messages: [],
    },
  }),
  false,
